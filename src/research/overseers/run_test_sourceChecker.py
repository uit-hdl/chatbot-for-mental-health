...
prompt_template_path_relative_1 = "files/prompt-templates/source-fidelity/swift-judges/swift_judge_source_fidelity_chain_of_thought_v2.md"
...
test_cases = [
    ...
    {"name": "raising_awareness", "color": "green"},
...
# %%
k = 0
while k < len(test_cases):
    test_case_name = test_cases[k]["name"]
    if test_cases[k]["color"]=="green":
    if test_prompt_0:
