...
def check_sources(conversation, harvested_syntax: dict, chatbot_id: str) -> list:
    ...
    if source_names:
        system_message = generate_overseer_input(bot_message, source_names)
        overseer = create_ai_agent("overseer", system_message)
...
def generate_overseer_input(bot_message: str, source_names: list[str]) -> str:
